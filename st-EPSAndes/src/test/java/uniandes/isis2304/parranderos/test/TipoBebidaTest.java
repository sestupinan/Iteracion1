...
public class TipoBebidaTest
{
	...
	public void CRDTipoBebidaTest() 
	{
		...
		try
		{
			...
			parranderos = new EPSAndes (openConfig (CONFIG_TABLAS_A));
		}
		catch (Exception e)
		{
//			e.printStackTrace();
    	...
    	try
		{
			...
			VOServicioSalud tipoBebida1 = parranderos.adicionarTipoBebida (nombreTipoBebida1);
			...
			VOServicioSalud tipoBebida2 = parranderos.adicionarTipoBebida (nombreTipoBebida2);
			lista = parranderos.darVOTiposBebida();
...
//			e.printStackTrace();
		...
		try
		{
			...
			VOServicioSalud tipoBebida2 = parranderos.adicionarTipoBebida (nombreTipoBebida1);
