...
public class EPSAndes 
{
	 ...
	 */
	public ServicioSalud adicionarTipoBebida (String nombre)
	{
        log.info ("Adicionando Tipo de bebida: " + nombre);
        ServicioSalud tipoBebida = pp.adicionarTipoBebida (nombre);		
	...
	public List<ServicioSalud> darTiposBebida ()
	{
        ...
        List<ServicioSalud> tiposBebida = pp.darTiposBebida ();	
	 ...
	 */
	public List<VOServicioSalud> darVOTiposBebida ()
	{
		log.info ("Generando los VO de Tipos de bebida");        
        List<VOServicioSalud> voTipos = new LinkedList<VOServicioSalud> ();
        for (ServicioSalud tb : pp.darTiposBebida ())
        {
        	voTipos.add (tb);
        }
	 ...
	 */
	public ServicioSalud darTipoBebidaPorNombre (String nombre)
	{
		log.info ("Buscando Tipo de bebida por nombre: " + nombre);
		List<ServicioSalud> tb = pp.darTipoBebidaPorNombre (nombre);
	 ...
	 */
	public ConsultaUrgencias adicionarBebedor (String nombre, String presupuesto, String ciudad)
	{
        log.info ("Adicionando bebedor: " + nombre);
        ConsultaUrgencias bebedor = pp.adicionarBebedor (nombre, presupuesto, ciudad);
	...
	public ConsultaUrgencias darBebedorPorId (long idBebedor)
	{
        ...
        ConsultaUrgencias bebedor = pp.darBebedorPorId (idBebedor);
	 ...
	 */
	public List<ConsultaUrgencias> darBebedoresPorNombre (String nombre)
	{
        log.info ("Dar información de bebedores por nombre: " + nombre);
        List<ConsultaUrgencias> bebedores = pp.darBebedoresPorNombre (nombre);
	 ...
	 * 	La lista vacía indica que no existen bebedores con ese nombre
	 */
	public List<VOConsultaUrgencias> darVOBebedoresPorNombre (String nombre)
	{
        log.info ("Generando VO de bebedores por nombre: " + nombre);
        List<VOConsultaUrgencias> voBebedores = new LinkedList<VOConsultaUrgencias> ();
       for (ConsultaUrgencias bdor : pp.darBebedoresPorNombre (nombre))
       {
	...
	public List<ConsultaUrgencias> darBebedores ()
	{
        ...
        List<ConsultaUrgencias> bebedores = pp.darBebedores ();	
	 ...
	 */
	public List<VOConsultaUrgencias> darVOBebedores ()
	{
        log.info ("Generando los VO de Bebedores");
         List<VOConsultaUrgencias> voBebedores = new LinkedList<VOConsultaUrgencias> ();
        for (ConsultaUrgencias bdor : pp.darBebedores ())
        {
        	voBebedores.add (bdor);
        }
        log.info ("Generando los VO de Bebedores: " + voBebedores.size() + " bebedores existentes");
	 ...
	 */
	public ConsultaMedica adicionarBar (String nombre, String presupuesto, String ciudad, int sedes)
	{
        log.info ("Adicionando bar: " + nombre);
        ConsultaMedica bar = pp.adicionarBar (nombre, presupuesto, ciudad, sedes);
	...
	public List<ConsultaMedica> darBares ()
	{
        ...
        List<ConsultaMedica> bares = pp.darBares ();	
	 ...
	 * @return Una lista de objetos Bar con todos las bares que conoce la aplicación, llenos con su información básica
	 */
	public List<VOConsultaMedica> darVOBares ()
	{
		log.info ("Generando los VO de Bares");
		List<VOConsultaMedica> voBares = new LinkedList<VOConsultaMedica> ();
		for (ConsultaMedica bar: pp.darBares ())
		{
			voBares.add (bar);
		}
	 ...
	 */
	public ConsultaControl adicionarGustan (long idBebedor, long idBebida)
	{
        log.info ("Adicionando gustan [" + idBebedor + ", " + idBebida + "]");
        ConsultaControl resp = pp.adicionarGustan (idBebedor, idBebida);
	...
	public List<ConsultaControl> darGustan ()
	{
        ...
        List<ConsultaControl> gustan = pp.darGustan ();	
	 ...
	 * @return Una lista de objetos Gustan con todos los GUSTAN que conoce la aplicación, llenos con su información básica
	 */
	public List<VOConsultaControl> darVOGustan ()
	{
		log.info ("Generando los VO de Gustan");
		List<VOConsultaControl> voGustan = new LinkedList<VOConsultaControl> ();
		for (VOConsultaControl bar: pp.darGustan ())
		{
			voGustan.add (bar);
		}
	 ...
	 */
	public Hospitalizacion adicionarSirven (long idBar, long idBebida, String horario)
	{
        log.info ("Adicionando sirven [" + idBar + ", " + idBebida + "]");
        Hospitalizacion resp = pp.adicionarSirven (idBar, idBebida, horario);
	...
	public List<Hospitalizacion> darSirven ()
	{
        ...
        List<Hospitalizacion> sirven = pp.darSirven ();	
	 ...
	 */
	public List<VOHospitalizacion> darVOSirven ()
	{
		log.info ("Generando los VO de Sirven");
		List<VOHospitalizacion> voGustan = new LinkedList<VOHospitalizacion> ();
		for (VOHospitalizacion sirven: pp.darSirven ())
		{
			voGustan.add (sirven);
		}
