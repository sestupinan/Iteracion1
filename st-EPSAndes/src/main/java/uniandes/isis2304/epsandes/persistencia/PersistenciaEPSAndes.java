...
public class PersistenciaEPSAndes 
{
	...
	public ServicioSalud adicionarTipoBebida(String nombre)
	{
        ...
        try
        {
            ...
            return new ServicioSalud (idTipoBebida, nombre);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
...
//        	e.printStackTrace();
	...
	public RemisionEspecialista adicionarBebida(String nombre, long idTipoBebida, int gradoAlcohol) 
	{
        ...
        try
        {
            ...
            return new RemisionEspecialista (idBebida,nombre, idTipoBebida, gradoAlcohol);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
...
//        	e.printStackTrace();
	 ...
	 */
	public ConsultaUrgencias adicionarBebedor(String nombre, String ciudad, String presupuesto) 
	{
		PersistenceManager pm = pmf.getPersistenceManager();
        Transaction tx=pm.currentTransaction();
        try
        {
            ...
            return new ConsultaUrgencias (idBebedor, nombre, ciudad, presupuesto);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
...
//        	e.printStackTrace();
	...
	public List<Object []> darBebedoresYNumVisitasRealizadas ()
	{
        ...
        for ( Object tupla : tuplas)
        {
			...
			resp [0] = new ConsultaUrgencias (idBebedor, nombreBebedor, ciudadBebedor, presupuesto);
			resp [1] = numBares;	
...
//        	e.printStackTrace();
	...
	private List<Object []> armarVisitasBebedor (List<Object []> tuplas)
	{
		...
		for (Object [] tupla : tuplas)
		{
			...
			visita [0] = new ConsultaMedica (idBar, nombreBar, ciudadBar, presupuestoBar, sedesBar);
	...
	private List<Object []> armarGustanBebedor (List<Object []> tuplas)
	{
		...
		{			
			...
			gusta [0] = new RemisionEspecialista (idBebida, nombreBebida, idTipoBebida, gradoAlcohol);
			gusta [1] = nombreTipo;	
	 ...
	 */
	public ConsultaMedica adicionarBar(String nombre, String ciudad, String presupuesto, int sedes) 
	{
		PersistenceManager pm = pmf.getPersistenceManager();
        Transaction tx=pm.currentTransaction();
        try
        {
            ...
            return new ConsultaMedica (idBar, nombre, ciudad, presupuesto, sedes);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
...
//        	e.printStackTrace();
	...
	public ConsultaControl adicionarGustan(long idBebedor, long idBebida) 
	{
        ...
        try
        {
            ...
            return new ConsultaControl (idBebedor, idBebida);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
...
//        	e.printStackTrace();
	...
	public Hospitalizacion adicionarSirven (long idBar, long idBebida, String horario) 
	{
        ...
        try
        {
            ...
            return new Hospitalizacion (idBar, idBebida, horario);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
