...
//			e.printStackTrace ();
    ...
    public void demoTipoBebida( )
    {
    	try 
    	{
			...
			VOServicioSalud tipoBebida = parranderos.adicionarTipoBebida (nombreTipoBebida);
			if (tipoBebida == null)
			{
				tipoBebida = parranderos.darTipoBebidaPorNombre (nombreTipoBebida);
				errorTipoBebida = true;
			}
			List <VOServicioSalud> lista = parranderos.darVOTiposBebida();
...
//			e.printStackTrace();
	...
	public void demoBebida( )
    {
    	try 
    	{
			...
			VORemisionEspecialista bebida = parranderos.adicionarBebida(nombreBebida, tipoBebida.getId (), 10);
			
			List <VOServicioSalud> listaTiposBebida = parranderos.darVOTiposBebida();
			List <VORemisionEspecialista> listaBebidas = parranderos.darVOBebidas();
...
//			e.printStackTrace();
    ...
    public void demoElimNoServidas1 ( )
    {
    	try 
    	{
			...
			VORemisionEspecialista bebida1 = parranderos.adicionarBebida("120", tipoBebida.getId (), 10);
			VORemisionEspecialista bebida2 = parranderos.adicionarBebida("Gato Negro", tipoBebida.getId (), 11);
			VORemisionEspecialista bebida3 = parranderos.adicionarBebida("Don Pedro", tipoBebida.getId (), 12);
			
			List <VOServicioSalud> listaTiposBebida = parranderos.darVOTiposBebida();
			List <VORemisionEspecialista> listaBebidas1 = parranderos.darVOBebidas();
			List <VOHospitalizacion> listaSirven = parranderos.darVOSirven ();
			long noServidasEliminadas = parranderos.eliminarBebidasNoServidas();
			List <VORemisionEspecialista> listaBebidas2 = parranderos.darVOBebidas();
...
//			e.printStackTrace();
    ...
    public void demoElimNoServidas2 ( )
    {
    	try 
    	{
			...
			VORemisionEspecialista bebida2 = parranderos.adicionarBebida("Gato Negro", tipoBebida.getId (), 11);
			VORemisionEspecialista bebida3 = parranderos.adicionarBebida("Don Pedro", tipoBebida.getId (), 12);
			VOConsultaMedica bar1 = parranderos.adicionarBar ("Los Amigos", "Bogotá", "Bajo", 2);
			parranderos.adicionarSirven (bar1.getId (), bebida1.getId (), "diurno");
			
			List <VOServicioSalud> listaTiposBebida = parranderos.darVOTiposBebida();
			List <VORemisionEspecialista> listaBebidas1 = parranderos.darVOBebidas();
			List <VOConsultaMedica> bares = parranderos.darVOBares ();
			List <VOHospitalizacion> sirven = parranderos.darVOSirven ();
			long noServidasEliminadas = parranderos.eliminarBebidasNoServidas();
			List <VORemisionEspecialista> listaBebidas2 = parranderos.darVOBebidas();
...
//			e.printStackTrace();
    ...
    public void demoBar ( )
    {
		try 
		{
			...
			List <VOConsultaMedica> lista = parranderos.darVOBares ();
...
//			e.printStackTrace();
    ...
    public void demoBaresBebidas ( )
    {
		try 
		{
			...
			// ATENCIÓN: En una aplicación real, los datos JAMÁS están en el código
			boolean errorTipoBebida = false;
			VOServicioSalud tipoBebida = parranderos.adicionarTipoBebida ("Vino tinto");
			if (tipoBebida == null)
			{
			...
			VORemisionEspecialista bebida1 = parranderos.adicionarBebida ("120", tipoBebida.getId (), 10);
			VORemisionEspecialista bebida2 = parranderos.adicionarBebida ("121", tipoBebida.getId (), 10);
			VORemisionEspecialista bebida3 = parranderos.adicionarBebida ("122", tipoBebida.getId (), 10);
			VORemisionEspecialista bebida4 = parranderos.adicionarBebida ("123", tipoBebida.getId (), 10);
			VORemisionEspecialista bebida5 = parranderos.adicionarBebida ("124", tipoBebida.getId (), 10);
			VOConsultaMedica bar1 = parranderos.adicionarBar ("Los Amigos1", "Bogotá", "Bajo", 2);
			VOConsultaMedica bar2 = parranderos.adicionarBar ("Los Amigos2", "Bogotá", "Bajo", 3);
			VOConsultaMedica bar3 = parranderos.adicionarBar ("Los Amigos3", "Bogotá", "Bajo", 4);
			VOConsultaMedica bar4 = parranderos.adicionarBar ("Los Amigos4", "Medellín", "Bajo", 5);
			parranderos.adicionarSirven (bar1.getId (), bebida1.getId (), "diurno");
...
//			e.printStackTrace();
    ...
    public void demoAumentarSedesBaresEnCiudad ( )
    {
		try 
		{
			...
			List <VOConsultaMedica> listaBares2 = parranderos.darVOBares ();
...
//			e.printStackTrace();
	...
	public void demoBebedor ( )
    {
		try 
		{
    		// Ejecución de la demo y recolección de los resultados
			// ATENCIÓN: En una aplicación real, los datos JAMÁS están en el código
			VOConsultaUrgencias bdor1 = parranderos.adicionarBebedor ("Pepito", "Bogotá", "Alto");
			VOConsultaUrgencias bdor2 = parranderos.adicionarBebedor ("Pepito", "Medellín", "Alto");
			VOConsultaUrgencias bdor3 = parranderos.adicionarBebedor ("Pedrito", "Cali", "Alto");
			
			List <VOConsultaUrgencias> bebedores = parranderos.darVOBebedores();
			VOConsultaUrgencias bdor5 = parranderos.darBebedorPorId(bdor1.getId ());
			VOConsultaUrgencias bdor6 = parranderos.darBebedorPorId(0);
			List <VOConsultaUrgencias> pepitos = parranderos.darVOBebedoresPorNombre("Pepito");
			List <VOConsultaUrgencias> pedritos = parranderos.darVOBebedoresPorNombre("Pedrito");
...
//			e.printStackTrace();
    ...
    public void demoDarBebedorCompleto ( )
    {
		try 
		{
			...
			List <VOServicioSalud> listaTipos = parranderos.darVOTiposBebida();
			List <VORemisionEspecialista> listaBebidas = parranderos.darVOBebidas();
			List <VOConsultaMedica> listaBares = parranderos.darVOBares ();
			List <VOConsultaUrgencias> bebedores = parranderos.darVOBebedores();
    ...
    */
    public void demoCambiarCiudadBebedor ( )
    {
		try 
		{
			...
			List<VOConsultaUrgencias> bebedores1 = parranderos.darVOBebedores ();
			long bebedoresActualizados = parranderos.cambiarCiudadBebedor (bdor1.getId (), "Medellín");
			List<VOConsultaUrgencias> bebedores2 = parranderos.darVOBebedores ();
...
//			e.printStackTrace();
    ...
    public void demoBebedoresYNumVisitasRealizadas ( )
    {
		try 
		{
			...
			VOConsultaMedica bar4 = parranderos.adicionarBar ("Los Amigos4", "Medellín", "Bajo", 5);
			VOConsultaUrgencias bdor1 = parranderos.adicionarBebedor ("Pepito", "Bogotá", "Alto");
			VOConsultaUrgencias bdor2 = parranderos.adicionarBebedor ("Juanito", "Bogotá", "Alto");
			VOConsultaUrgencias bdor3 = parranderos.adicionarBebedor ("Carlitos", "Medellín", "Alto");
			VOConsultaUrgencias bdor4 = parranderos.adicionarBebedor ("Luis", "Cartagena", "Medio");
			parranderos.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			parranderos.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "nocturno");
			parranderos.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "todos");
...
//			e.printStackTrace();
    ...
    public void demoBebedoresDeCiudad ( )
    {
		try 
		{
			...
			VOConsultaMedica bar4 = parranderos.adicionarBar ("Los Amigos4", "Medellín", "Bajo", 5);
			VOConsultaUrgencias bdor1 = parranderos.adicionarBebedor ("Pepito", "Bogotá", "Alto");
			VOConsultaUrgencias bdor2 = parranderos.adicionarBebedor ("Juanito", "Medellín", "Alto");
			VOConsultaUrgencias bdor3 = parranderos.adicionarBebedor ("Pedrito", "Medellín", "Alto");
			parranderos.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			parranderos.adicionarVisitan (bdor1.getId (), bar2.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			parranderos.adicionarVisitan (bdor1.getId (), bar3.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			parranderos.adicionarVisitan (bdor2.getId (), bar3.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
...
//			e.printStackTrace();
	...
	public void limpiarBD ()
	{
		...
		{
    		// Ejecución de la demo y recolección de los resultados
			long eliminados [] = parranderos.limpiar();
...
//			e.printStackTrace();
     ...
     */
    private String listarTiposBebida(List<VOServicioSalud> lista) 
    {
     ...
     */
    private String listarBebidas (List<VORemisionEspecialista> lista) 
    {
    	String resp = "Las bebidas existentes son:\n";
    	int i = 1;
        for (VORemisionEspecialista beb : lista)
        {
        	resp += i++ + ". " + beb.toString() + "\n";
        }
        return resp;
     ...
     */
    private String listarBebedores (List<VOConsultaUrgencias> lista) 
    {
    	String resp = "Los bebedores existentes son:\n";
    	int i = 1;
        for (VOConsultaUrgencias bdor : lista)
        {
     ...
     */
    private String listarBares (List<VOConsultaMedica> lista) 
    {
    	String resp = "Los bares existentes son:\n";
    	int i = 1;
        for (VOConsultaMedica bar : lista)
        {
        	resp += i++ + ". " + bar.toString() + "\n";
        }
        return resp;
     ...
     */
    private String listarGustan (List<VOConsultaControl> lista) 
    {
    	String resp = "Los gustan existentes son:\n";
    	int i = 1;
        for (VOConsultaControl serv : lista)
        {
     ...
     */
    private String listarSirven (List<VOHospitalizacion> lista) 
    {
    	String resp = "Los sirven existentes son:\n";
    	int i = 1;
        for (VOHospitalizacion serv : lista)
        {
        	resp += i++ + ". " + serv.toString() + "\n";
        }
        return resp;
    ...
    private String listarBebedorYNumVisitas (List<Object[]> lista) 
    {
        ...
        {
			VOConsultaUrgencias bdor = (VOConsultaUrgencias) tupla [0];
